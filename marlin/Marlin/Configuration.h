...
#define STRING_CONFIG_H_AUTHOR "dibs marlin 1.0" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Denford's Kossel"   // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "I am"
